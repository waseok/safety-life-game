...
export const drugCyberSafety: Area = {
  ...
  situations: [
    // ────────── 약물오남용 (10개) ──────────
    {
      ...
      title: "학교 뒤편에서 담배를 권하는 친구들",
      body: "민준이는 방과 후 학교 뒤편에서 친구들이 담배를 피우고 있는 것을 발견했습니다. 그들이 \"한 번만 피워봐, 별거 아니야\"라며 민준이에게도 권유합니다.",
    ...
    },
    {
      ...
      title: "편의점 앞, 친구가 보여주는 전자담배",
      body: "이어서 민준이는 편의점 앞에서 친구가 과일 맛 전자담배를 내밀며 보여주는 장면을 마주쳤습니다. \"이건 물담배 같은 거라 몸에 안 나빠\"라고 합니다.",
      image: "/images/situations/area4/s01.png",
      choices: [
    ...
    },
    {
      ...
      title: "두통에 진통제를 더 먹으려는 민준",
      body: "계속해서 민준이는 두통이 너무 심해 약국에서 산 진통제를 먹었습니다. 효과가 없어 2알을 더 먹으려 했는데, 포장에는 1회 1알이라고 되어 있습니다.",
    ...
    },
    {
      ...
      title: "시험 기간 밤샘 공부 중 에너지 음료 3캔째",
      body: "그 다음 날, 시험 기간이 된 민준이는 밤새 공부해야 했습니다. 에너지 음료를 이미 2캔 마셨는데 졸음이 옵니다. 3캔째를 마실까 고민됩니다.",
      image: "/images/situations/area4/s02.png",
      choices: [
    ...
    },
    {
      ...
      title: "SNS 피드에 뜬 다이어트 약 광고의 유혹",
      body: "계속해서 스마트폰을 보던 민준이는 SNS에서 \"먹기만 하면 살이 빠지는 약\"이라는 광고를 봤습니다. 후기도 좋고 친구도 사용한다고 합니다.",
    ...
    },
    {
      ...
      title: "친구 집에서 본드를 내밀며 해보라는 친구",
      body: "이어서 민준이는 친구 집에서 놀다가 한 친구가 본드를 내밀며 \"이거 킁킁하면 기분 좋아진다\"고 하는 것을 듣게 됐습니다.",
      image: "/images/situations/area4/s02.png",
      choices: [
    ...
    },
    {
      ...
      title: "잠 못 자는 민준에게 수면제를 권하는 친구",
      body: "계속해서 시험 스트레스로 잠을 못 자던 민준이에게 친구가 수면제를 내밀며 \"잠이 안 올 때 이거 하나 먹으면 바로 잠든다\"고 합니다.",
      image: "/images/situations/area4/s02.png",
      choices: [
    ...
    },
    {
      ...
      title: "선배 집 파티에서 맥주를 권유받은 민준",
      body: "그 다음 날, 민준이는 선배 집에서 열리는 파티에 갔습니다. 자리에 앉자마자 선배가 맥주를 권하며 \"한 잔만 마셔. 이 정도는 모두 마시잖아\"라고 합니다.",
      image: "/images/situations/area4/s01.png",
      choices: [
    ...
    },
    {
      ...
      title: "화장실에서 이상한 약을 먹는 친구를 발견",
      body: "계속해서 민준이는 화장실에서 친구가 이상한 약을 먹는 것을 목격했습니다. 눈이 풀려 있고 행동이 평소와 다른데, 친구는 비밀로 해달라고 합니다.",
      image: "/images/situations/area4/s02.png",
      choices: [
    ...
    },
    {
      ...
      title: "카페인 과다 섭취로 나타난 손 떨림과 두근거림",
      body: "이어서 민준이는 최근 커피와 에너지 음료를 자주 마셨더니, 손이 떨리고 심장이 두근거리며 잠을 잘 못 자게 됐습니다.",
      image: "/images/situations/area4/s02.png",
      choices: [
    ...
    // ────────── 인터넷·스마트폰중독 (10개) ──────────
    {
      ...
      title: "밤새 게임에 빠진 민준, 학교에서도 게임 생각",
      body: "한편, 민준이는 새 게임이 너무 재밌어서 어제 밤새 했습니다. 오늘도 학교에서 게임 생각뿐이고, 집에 돌아가면 또 밤새 하고 싶습니다.",
    ...
    },
    {
      ...
      title: "5분마다 SNS 알림 확인, 비교하며 우울해지는 민준",
      body: "이어서 민준이는 SNS를 5분마다 확인하는 버릇이 생겼습니다. 좋아요 수가 신경 쓰이고, 다른 사람의 화려한 일상과 비교하며 기분이 우울해집니다.",
      image: "/images/situations/area4/s05.png",
      choices: [
    ...
    },
    {
      ...
      title: "용돈 2배로 불렸다는 친구의 스포츠 베팅 앱",
      body: "계속해서 친구가 민준이에게 스포츠 베팅 앱을 보여주며 \"용돈을 2배로 불렸다\"고 자랑합니다. 민준이에게도 쉬운 돈벌이인 것 같아 보입니다.",
      image: "/images/situations/area4/s05.png",
      choices: [
    ...
    },
    {
      ...
      title: "유튜브 알고리즘이 추천하는 폭력적인 영상",
      body: "그 다음 날, 민준이가 유튜브를 보던 중 자극적이고 폭력적인 영상이 자동으로 추천되기 시작했습니다. 눈에 띄는 썸네일 때문에 자꾸 클릭하게 됩니다.",
      image: "/images/situations/area4/s03.png",
      choices: [
    ...
    },
    {
      ...
      title: "택배 반송 문자에 URL, 클릭할 뻔한 민준",
      body: "이어서 민준이의 스마트폰에 \"택배가 반송되었습니다. 확인하세요\"라는 문자에 인터넷 주소(URL)가 왔습니다. 최근 주문한 것이 있어서 자신도 모르게 클릭할 뻔했습니다.",
    ...
    },
    {
      ...
      title: "중고 앱에서 찾은 초저가 게임기, 선입금 요구",
      body: "계속해서 민준이는 중고 거래 앱에서 시세보다 훨씬 싸게 게임기를 판매하는 글을 발견했습니다. \"선입금하면 바로 보내겠다\"는 판매자의 메시지가 왔습니다.",
      image: "/images/situations/area4/s04.png",
      choices: [
    ...
    },
    {
      ...
      title: "하루 8시간 스마트폰에 의존하는 민준의 일상",
      body: "그 다음 날, 민준이는 자신이 하루에 스마트폰을 8시간 이상 사용하고 있다는 것을 알게 됐습니다. 스마트폰 없이는 불안하고, 손에 항상 들고 있어야 합니다.",
      image: "/images/situations/area4/s05.png",
      choices: [
    ...
    },
    {
      ...
      title: "유튜버 실수 영상에 악성 댓글이 쏟아지다",
      body: "계속해서 민준이는 한 유튜버의 영상에서 실수를 발견했습니다. 댓글을 보니 많은 사람이 조롱하며 악성 댓글을 달고 있는 상황입니다.",
      image: "/images/situations/area4/s04.png",
      choices: [
    ...
    },
    {
      ...
      title: "게임 무료 핵 프로그램 다운로드 사이트를 발견",
      body: "이어서 민준이는 게임 무료 핵(치트) 프로그램이라는 파일을 다운로드 사이트에서 발견했습니다. 댓글에는 \"잘 된다\"라는 후기가 많습니다.",
      image: "/images/situations/area4/s04.png",
      choices: [
    ...
    },
    {
      ...
      title: "모바일 게임 한정판 아이템, 저장된 부모님 카드로 결제?",
      body: "계속해서 민준이가 즐기는 모바일 게임에서 한정판 아이템이 출시됐습니다. 스마트폰에 부모님 카드 정보가 저장되어 있어서 바로 결제할 수 있습니다.",
      image: "/images/situations/area4/s05.png",
      choices: [
